  ...
  return (
    <div className="flex flex-col gap-20 w-full h-full p-10 ">
      ...
      <div className="w-full flex flex-col gap-10">
        <button onClick={getImageHandler} className="bg-gray-300 px-6 py-4 text-gray-900">Test Get button</button>
        {imageSrc && <Image src={imageSrc} alt="Fetched from S3" width={400} height={400} />}
      </div>
      
      <div className="w-full flex flex-col gap-10">
        <button onClick={deleteHandler} className="bg-gray-300 px-6 py-4 text-gray-900">Delete Image</button>
      </div>
    </div>
  );
};
