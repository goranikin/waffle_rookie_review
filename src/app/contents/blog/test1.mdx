...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/1.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/2.png)
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/3.png)

인스턴스에 접속하기 위한 키 페어를 생성하자. 나중에 생성된 키 파일을 가지고 인스턴스에 접속한다.

![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/4.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/5.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/6.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/7.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/8.png)
...
![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/9.png)

서버가 실행됐다!

그리고 `http://<Public IPv4 주소>` 로 접속해보면...

![](/blog/deployment-of-nextjs-with-bun-using-ec2-nginx-pm2/10.png)
